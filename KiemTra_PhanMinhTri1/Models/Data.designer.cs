...
namespace KiemTra_PhanMinhTri1.Models
{
    ...
    partial void OnMaHPChanging(int value);
    partial void OnMaHPChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MaHP", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int MaHP
		{
			get
			{
